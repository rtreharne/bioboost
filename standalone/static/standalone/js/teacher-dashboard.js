...
document.querySelectorAll("[data-builder-toggle-form]").forEach((form) => {
  ...
  const feedback = form.closest(".dashboard-course-card")?.querySelector("[data-builder-toggle-feedback]");
  ...
  form.addEventListener("submit", async (event) => {
    ...
    try {
      ...
      if (feedback instanceof HTMLElement) {
        feedback.textContent = error instanceof Error ? error.message : "Unable to update the builder right now.";
