...
NINE POINT EIGHT ONE is a Django-based product codebase with a standalone app at `/app/` for invite-based teacher and student workflows. The root URL `/` now serves the branded homepage and routes users into sign-in or dashboard flow.
...
Then open `http://127.0.0.1:8000/` or `http://127.0.0.1:8000/app/login/` to sign in.
