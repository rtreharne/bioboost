...
OPENAI_QUESTION_MODEL = env_str("OPENAI_QUESTION_MODEL", OPENAI_MODEL)
OPENAI_NUMERIC_MODEL = env_str("OPENAI_NUMERIC_MODEL", OPENAI_MODEL)
OPENAI_NUMERIC_FEEDBACK_REGEN_MODEL = env_str("OPENAI_NUMERIC_FEEDBACK_REGEN_MODEL", "gpt-4.1")
OPENAI_EMBEDDING_MODEL = os.getenv("OPENAI_EMBEDDING_MODEL", "text-embedding-3-small")
OPENAI_BLOCK_AVATAR_MODEL = env_str("OPENAI_BLOCK_AVATAR_MODEL", "gpt-image-1.5")
BLOCK_CONTENT_HEURISTIC_FALLBACK_ENABLED = env_bool("BLOCK_CONTENT_HEURISTIC_FALLBACK_ENABLED", False)
PREVIEW_WAQ_OPENAI_DRAFT_ENABLED = env_bool("PREVIEW_WAQ_OPENAI_DRAFT_ENABLED", False)
